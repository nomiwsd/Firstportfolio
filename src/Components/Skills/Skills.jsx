      ...
      <div className='container'>
        <div class="col-md-12 heading-section text-center text-white py-5">
          <span class="subheading text-center" data-aos="fade-left"
            data-aos-duration="500">Skills</span>
          <h2 class="mb-4 Mainheading" data-aos="fade-up"
            data-aos-duration="500">My Skills</h2>
        ...
        <div className="d-md-flex flex-md-row overfs gap-2 py-5 d-lg-none" data-aos="flip-left"
            data-aos-duration="500">
